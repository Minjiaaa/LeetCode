...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,2,3], sequences = [[1,2],[1,3]]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,2,3], sequences = [[1,2]]
<strong>Output:</strong> false
...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,2,3], sequences = [[1,2],[1,3],[2,3]]
